...
package { 'device-mapper':
  ensure => '1.02.140-8.el7',
}
package { 'device-mapper-libs':
  ensure => '1.02.140-8.el7',
}
package { 'dhclient':
  ensure => '4.2.5-58.el7.centos',
}
package { 'dhcp-common':
  ensure => '4.2.5-58.el7.centos',
}
...
package { 'iptables':
  ensure => '1.4.21-18.0.1.el7.centos',
}
package { 'iputils':
...
package { 'kmod':
  ensure => '20-15.el7_4.2',
}
package { 'kmod-libs':
  ensure => '20-15.el7_4.2',
}
package { 'kpartx':
  ensure => '0.4.9-111.el7',
}
package { 'krb5-libs':
  ensure => '1.15.1-8.el7',
}
...
package { 'linux-firmware':
  ensure => '20170606-56.gitc990aae.el7',
}
package { 'logrotate':
  ensure => '3.8.6-14.el7',
}
...
package { 'nfs-utils':
  ensure => '1.3.0-0.48.el7',
}
package { 'nspr':
  ensure => '4.13.1-1.0.el7_3',
}
package { 'nss':
  ensure => '3.28.4-12.el7_4',
}
package { 'nss-pem':
  ensure => '1.0.3-4.el7',
}
